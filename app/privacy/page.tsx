const Privacy = () => {
  return (
    <main className="bg-[#0b132b] text-slate-100 w-full px-20 py-20 flex flex-col gap-4">
      <h1 className="text-3xl">Privacy Policy for Nextjs dashboard</h1>

      <p>
        At Nextjs dashboard, accessible from
        talavin-nextjs-dashboard.vercel.app, one of our main priorities is the
        privacy of our visitors. This Privacy Policy document contains types of
        information that is collected and recorded by Nextjs dashboard and how
      ...
      <p>
        Note that Nextjs dashboard has no access to or control over these
      ...
      <p>
        Nextjs dashboard does not knowingly collect any Personal Identifiable
      ...
      <h2 className="text-2xl">Online Privacy Policy Only</h2>

      <p>
        This Privacy Policy applies only to our online activities and is valid
        for visitors to our website with regards to the information that they
        shared and/or collect in Nextjs dashboard. This policy is not applicable
